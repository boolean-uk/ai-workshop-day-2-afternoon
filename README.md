...
- https://github.com/Valen98/ai-todo (React vite App) 
![Copilot](Copilot-react-vite.png)
- https://github.com/Valen98/ai-backend (Backend of Todo)
![BackendApi](Copilot-backend-api.png)
- 
